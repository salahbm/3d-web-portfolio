...
const Home = () => {
  ...
  const [isIsland2Position, isIsland2Scale, isIsland2Rotation] =
    adjustIsland2ForScreenSize();
  ...
  return (
    ...
    >
      ...
      >
        <Suspense fallback={<Loader />}>
          ...
          <hemisphereLight
            ...
            intensity={1}
          />
          {swapIslands === "foxIsland" ? <Bird /> : <Bird2 />}
          ...
          {swapIslands === "foxIsland" ? (
            ...
            <Island2
              position={isIsland2Position}
              scale={isIsland2Scale}
              rotation={isIsland2Rotation}
              isRotating={isRotating}
              setIsRotating={setIsRotating}
              setCurrentStage={setCurrentStage}
            />
      ...
      <div
        className="fixed bottom-4 md:left-[45%] left-[38%] translate-[50%] flex space-x-2"
        style={{ zIndex: 9999 }}
      >
        <img
          src={swap}
          ...
          onClick={() =>
            swapIslands === "diamond"
              ? setSwapIslands("foxIsland")
              : setSwapIslands("diamond")
          }
        />
      </div>

      <div
        className="fixed bottom-4 md:left-[49%] left-[47%] translate-[50%] flex space-x-2"
        style={{ zIndex: 9999 }}
      >
        <img
          src={arrow}
          alt="ScrollButton"
          className={`md:w-10 md:h-10 w-7 h-7 cursor-pointer ${
            scrollY === 0 ? "rotate-90" : "-rotate-90"
          } object-contain`}
          onClick={() =>
            scrollY === 0 ? handleScroll("down") : handleScroll("up")
          }
        />
      </div>
